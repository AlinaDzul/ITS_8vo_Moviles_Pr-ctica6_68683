...
const Pokedex: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const onBigBlueButtonClick = (e: React.MouseEvent<HTMLDivElement>) => {
        ...
        if (screen === EPokedexScreen.MENU) {
            ...
            router.push(`/${path}`);
        } else if (screen === EPokedexScreen.POKEDEX && (window as any).handleButtonClick) {
    ...
    const handleNavigation = (direction: string) => {
        if (screen === EPokedexScreen.POKEDEX && (window as any).handleNavigation) {
            (window as any).handleNavigation(direction);
        }
    };
            ...
            <IonContent fullscreen>
                <div id="pokedex">
                    <div id="left">
                        ...
                        <Cross onNavigate={handleNavigation} />
                    </div>
                </div>
            </IonContent>
        </IonPage>
